...
int main(int argc, char* argv[]) {
	...
	wcscpy_s(DirPath, MAX_PATH, L"D:\\PFSafetyGuard\\PFSafetyGuard\\PFDLL\\x64\\Release");

	// 文件路径
//char DLLPath[MAX_PATH + 1] = "C:\\Users\\86151\\Desktop\\PFSafetyGuard\\PFSafetyGuard\\PFDLL\\x64\\Release\\PFDLL.dll"; // dll的地址
	char DLLPath[MAX_PATH + 1] = "D:\\PFSafetyGuard\\PFSafetyGuard\\PFDLL\\x64\\Release\\PFDLL.dll"; // dll的地址
	// ******需要修改部分**********
	// 要注入DLL的EXE路径初始化
	WCHAR EXE[MAX_PATH + 1] = { 0 };


	wcscpy_s(EXE, MAX_PATH, L"D:\\PFSafetyGuard\\PFSafetyGuard\\testCode\\x64\\Release\\testCode.exe");
